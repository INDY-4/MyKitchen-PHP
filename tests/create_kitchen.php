<form action="../kitchens/create.php" method="POST">
    ...
    <input type="text" id="kitchen_owner_id" name="kitchen_owner_id" required><br>
    
    <label for="kitchen_name">Kitchen Name:</label>
    <input type="text" id="kitchen_name" name="kitchen_name" required><br>

    <label for="kitchen_working_hours">Working Hours:</label>
    <input type="text" id="kitchen_working_hours" name="kitchen_working_hours" required><br>
